...
const Footer = () => {
  return (
    <div className="flex flex-col text-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500 "
    >
      ...
      <p className="mb-12 font-bold">
        Copyright &copy; Appun Computers, Gohpur(Assam).
      </p>
    </div>
  );
};
